...
namespace RestSharp.Authenticators.OAuth
{
    ...
    internal static class OAuthTools
    {
        ...
        {
            return GetSignature(signatureMethod, OAuthSignatureTreatment.Escaped, signatureBase, consumerSecret, null, privateKey);
        }
        ...
        public static string GetSignature(OAuthSignatureMethod signatureMethod, OAuthSignatureTreatment signatureTreatment,
            string signatureBase, string consumerSecret, AsymmetricAlgorithm privateKey = null)
        {
            return GetSignature(signatureMethod, signatureTreatment, signatureBase, consumerSecret, null, privateKey);
        }
        ...
        /// <returns></returns>
        public static string GetSignature(OAuthSignatureMethod signatureMethod, string signatureBase, string consumerSecret,
            string tokenSecret, AsymmetricAlgorithm privateKey = null)
        {
            return GetSignature(signatureMethod, OAuthSignatureTreatment.Escaped, consumerSecret, tokenSecret, privateKey);
        }
        ...
        /// <returns></returns>
        public static string GetSignature(OAuthSignatureMethod signatureMethod, OAuthSignatureTreatment signatureTreatment,
            string signatureBase, string consumerSecret, string tokenSecret, AsymmetricAlgorithm privateKey = null)
        {
            ...
            switch (signatureMethod)
            {
                ...
                case OAuthSignatureMethod.RsaSha1:
                    {
                        if (privateKey == null) { throw new Exception("A key is required for RSA-SHA1 signing."); }
                        ...
                        cs.Close();
                        var formatter = new RSAPKCS1SignatureFormatter(privateKey);
