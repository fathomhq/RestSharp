...
namespace RestSharp.Authenticators
{
    ...
    public class OAuth1Authenticator : IAuthenticator
    {
        ...
        public static OAuth1Authenticator ForRequestToken(string consumerKey, string consumerSecret, string callbackUrl,
            OAuthSignatureMethod signatureMethod = OAuthSignatureMethod.HmacSha1, AsymmetricAlgorithm key = null)
        {
            OAuth1Authenticator authenticator = ForRequestToken(consumerKey, consumerSecret, signatureMethod, key);
        ...
        public static OAuth1Authenticator ForAccessToken(string consumerKey, string consumerSecret, string token, string tokenSecret, OAuthSignatureMethod signatureMethod = OAuthSignatureMethod.HmacSha1, AsymmetricAlgorithm key = null)
        {
            OAuth1Authenticator authenticator = new OAuth1Authenticator
            {
                ParameterHandling = OAuthParameterHandling.HttpAuthorizationHeader,
        ...
        public static OAuth1Authenticator ForAccessToken(string consumerKey, string consumerSecret, string token, string tokenSecret, string verifier,
            OAuthSignatureMethod signatureMethod = OAuthSignatureMethod.HmacSha1, AsymmetricAlgorithm key = null)
        {
            OAuth1Authenticator authenticator = ForAccessToken(consumerKey, consumerSecret, token, tokenSecret, signatureMethod, key);
